...
public class UpdateChecker {
    ...
    private static void setLatestVersion(String newVersion) { latestVersion = newVersion; }
    private static void setLatestDate(String newDate) { latestDate = newDate; }
    private static void setCurrentVersion(String newVersion) { currentVersion = newVersion; }
    public static String getLatestVersion() { return latestVersion; }
    public static String getLatestDate() { return latestDate; }
    public static String getAvailableLinks() { return availableLinks; }
